...
usage = """%prog python HERO.py -sr <high quality reads > -lc <long reads/contigs>  -o <output file>  -t <threads (int)> -s <split number (int)>
...
def correct(con, reads, out_con2, folder, mc, split_nu, threads, hlong_reads, bin, platform):
        ...
        threads2 = 30 if threads > 30 else threads
